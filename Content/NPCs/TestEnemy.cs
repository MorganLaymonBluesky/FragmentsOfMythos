using FragmentsOfMythos.Content.Items;
...
namespace FragmentsOfMythos.Content.NPCs
{
    ...
    public class TestEnemy : ModNPC
    {
        ...
        public override void OnKill()
        {
            if (Main.netMode == NetmodeID.MultiplayerClient)
            {
                Item.NewItem(NPC.GetSource_Death(), NPC.Center, ModContent.ItemType<TestMelee>());
                return;
            }
        }
